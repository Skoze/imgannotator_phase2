...
public interface TaskService {
    public Response releaseTask(String username, String taskname, String taskDescription,int numberOfImages, int taskTime, String[] taskTag, int credits, int maxWorkers);
